...
<div class = "row-fluid">
    <div class = "col-lg-12">
        <h1>
            <img src = "<?php echo RESOURCES_PATH . '/img/apache.png'; ?>" />
...
<div class = "row-fluid">
    <div class = "col-lg-6">
      ...
      <span class = "list-group-item apache-checkport">
        <span class="loader float-end"><img src = "<?php echo RESOURCES_PATH . '/img/loader.gif'; ?>" /></span>
...
<div class = "border grid-list mt-3">
    ...
    <div class = "row-fluid">
        <div class = "col-lg-12 apache-moduleslist d-flex flex-wrap mb-2">
            <span class = "loader"><img src = "<?php echo RESOURCES_PATH . '/img/loader.gif'; ?>" /></span>
        </div>
    </div>
</div>
<div class = "border grid-list mt-3">
