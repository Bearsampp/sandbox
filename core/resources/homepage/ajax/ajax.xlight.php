...
// Check SMTP port
$smtpPort = $bearsamppBins->getXlight()->getSmtpPort();
...
/**
 * Check if the Xlight service is running on the specified SMTP port.
 ...
 */
if ($bearsamppBins->getXlight()->checkPort($smtpPort)) {
    if ($bearsamppBins->getXlight()->checkPort($smtpPort)) {
