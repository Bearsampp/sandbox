 ...
 * It extends the Module class and provides functionality to manage MariaDB services,
 * configurations, and operations such as changing ports and root passwords.
 */
class BinMariadb extends Module
{
    ...
    /**
     * Reloads the configuration and settings for the MariaDB module.
     *
    ...
    /**
     * Changes the port for the MariaDB service.
     *
    ...
    /**
     * Checks if the specified port is in use by MariaDB.
     *
     * @param   int   $port        The port number to check.
     * @param   bool  $showWindow  Whether to show a message box with the result.
     *
     * @return bool Returns true if the port is used by MariaDB, false otherwise.
     */
    ...
    /**
     * Changes the root password for the MariaDB service.
     *
    ...
    /**
     * Switches the version of the MariaDB service.
     *
    ...
    /**
     * Updates the configuration for the MariaDB service.
     *
     * @param   string|null  $version     The version to update to.
     * @param   int          $sub         The sub-level for configuration updates.
     * @param   bool         $showWindow  Whether to show a message box with the result.
     *
    ...
    /**
     * Executes a command line instruction and retrieves the output.
     *
     * @param   string  $cmd  The command to be executed.
     *
     * @return array An associative array containing:
     *               - 'syntaxOk': A boolean indicating if the command executed without syntax errors.
     *               - 'content': The output content of the command.
     */
    ...
    /**
     * Sets the version of the module and reloads its configuration.
     *
    ...
    /**
     * Retrieves the service object associated with the module.
     *
    ...
    /**
     * Enables or disables the module and updates its configuration.
     *
    ...
    /**
     * Retrieves the path to the CLI executable file.
     *
     * @return string The path to the CLI executable file.
     */
    ...
    /**
     * Retrieves the path to the admin executable file.
     *
     * @return string The path to the admin executable file.
     */
