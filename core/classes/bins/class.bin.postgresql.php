 ...
 * It handles the configuration, initialization, and management of the PostgreSQL service.
 */
class BinPostgresql extends Module
{
    ...
    /**
     * Reloads the configuration and settings for the PostgreSQL module.
     *
    ...
    /**
     * Changes the port for the PostgreSQL service.
     *
     * @param   int    $port           The new port number.
     * @param   bool   $checkUsed      Whether to check if the port is already in use.
     * @param   mixed  $wbProgressBar  The progress bar object for Winbinder.
     *
     * @return bool|string Returns true if the port is changed successfully, or the process using the port if it is in use.
     */
    ...
    /**
     * Checks if the specified port is used by the PostgreSQL service.
     *
     * @param   int   $port        The port number to check.
     * @param   bool  $showWindow  Whether to show a message box with the result.
     *
     * @return bool Returns true if the port is used by PostgreSQL, false otherwise.
     */
    ...
    /**
     * Changes the root password for the PostgreSQL service.
     *
     * @param   string  $currentPwd     The current root password.
     * @param   string  $newPwd         The new root password.
     * @param   mixed   $wbProgressBar  The progress bar object for Winbinder.
     *
     * @return bool|string Returns true if the password is changed successfully, or an error message if it fails.
     */
     ...
     *
     * @param   string|null  $currentPwd     The current root password.
     * @param   mixed        $wbProgressBar  The progress bar object for Winbinder.
     *
     * @return bool|string Returns true if the password is correct, or an error message if it fails.
     */
    ...
    /**
     * Updates the configuration for the PostgreSQL service.
     *
     * @param   string|null  $version     The version to update to.
     * @param   int          $sub         The sub-level for the update.
     * @param   bool         $showWindow  Whether to show a message box with the result.
     *
    ...
    /**
     * Initializes the PostgreSQL data directory if it does not already exist.
     *
     * This method checks if the `data` directory exists within the specified path.
     * If the directory does not exist, it calls the `Batch::initializePostgresql` method
     * to initialize the PostgreSQL data directory.
     *
     * @param   string|null  $path  The path where the PostgreSQL data directory should be initialized.
     *                              If null, the current path of the PostgreSQL instance is used.
     */
    ...
    /**
     * Rebuilds the PostgreSQL configuration files with the current port settings.
     *
     * This method updates the `port` setting in both the primary and alternate
     * PostgreSQL configuration files to match the current port of the PostgreSQL instance.
     */
     ...
     *
     * This method runs a specified command using the PostgreSQL command line interface (CLI)
     * and captures the output. If the CLI executable is not found, it returns null.
     *
     * @param   string  $cmd  The command to be executed.
     *
     * @return string|null The output of the command, or null if the CLI executable is not found.
     */
    ...
    /**
     * Sets the PostgreSQL version and reloads the configuration.
     *
     * This method updates the PostgreSQL version in the configuration and reloads
     * the PostgreSQL instance to apply the new version settings.
     *
    ...
    /**
     * Retrieves the PostgreSQL service instance.
     *
     * @return Win32Service The PostgreSQL service instance.
     */
    ...
    /**
     * Enables or disables the PostgreSQL service.
     *
     * This method updates the enable status of the PostgreSQL service in the configuration.
     * If enabling, it checks if the current path exists and installs the service if necessary.
     * If disabling, it removes the service.
     *
    ...
    /**
     * Retrieves the path to the PostgreSQL error log file.
     *
     * @return string The path to the PostgreSQL error log file.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL control executable.
     *
     * @return string The path to the PostgreSQL control executable.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL command line interface executable.
     *
     * @return string The path to the PostgreSQL CLI executable.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL dump executable.
     *
     * @return string The path to the PostgreSQL dump executable.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL dump-all executable.
     *
     * @return string The path to the PostgreSQL dump-all executable.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL configuration file.
     *
     * @return string The path to the PostgreSQL configuration file.
     */
    ...
    /**
     * Retrieves the path to the PostgreSQL host-based authentication (HBA) configuration file.
     *
     * @return string The path to the PostgreSQL HBA configuration file.
     */
    ...
    /**
     * Retrieves the port number used by the PostgreSQL service.
     *
     * @return int The port number used by the PostgreSQL service.
     */
    ...
    /**
     * Sets the port number for the PostgreSQL service.
     *
     * This method updates the port number in the configuration and reloads the PostgreSQL instance.
     *
    ...
    /**
     * Retrieves the root user for the PostgreSQL service.
     *
     * @return string The root user for the PostgreSQL service.
     */
    ...
    /**
     * Sets the root user for the PostgreSQL service.
     *
     * This method updates the root user in the configuration and reloads the PostgreSQL instance.
     *
     * @param   string  $rootUser  The new root user to be set.
     */
    ...
    /**
     * Retrieves the root password for the PostgreSQL service.
     *
     * @return string The root password for the PostgreSQL service.
     */
    ...
    /**
     * Sets the root password for the PostgreSQL service.
     *
     * This method updates the root password in the configuration and reloads the PostgreSQL instance.
     *
