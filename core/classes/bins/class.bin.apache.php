 ...
 * Class BinApache
 *
 * This class extends the Module class and manages the Apache server configuration and operations within the Bearsampp application.
 * It handles enabling/disabling the Apache service, switching versions, changing ports, and refreshing configurations.
 */
class BinApache extends Module
{
     ...
     *
     * @param   string  $id    The identifier for the Apache module.
    ...
    /**
     * Reloads the Apache module configuration.
     *
     * @param   string|null  $id    The identifier for the Apache module.
    ...
    /**
     * Changes the port for the Apache server.
     *
     * @param   int    $port           The new port number.
     * @param   bool   $checkUsed      Whether to check if the port is already in use.
     * @param   mixed  $wbProgressBar  The progress bar object for the UI.
     *
     * @return bool|string Returns true if the port was successfully changed, false if the port is in use, or an error message.
     */
     ...
     *
     * @return bool Returns true if the port is used by the Apache server, false otherwise.
     */
    ...
    /**
     * Switches the Apache server version.
     *
    ...
    /**
     * Updates the Apache server configuration.
     *
    ...
    /**
     * Retrieves the list of all modules by merging the modules from the folder and the configuration.
     *
     * @return array The merged and sorted list of modules.
     */
     ...
     *
     * @return array The list of modules from the configuration file with their status (on/off).
     */
     ...
     *
     * @return array The list of modules from the folder with their status set to off.
     */
     ...
     * @global object $bearsamppRoot Global object providing access to Bearsampp root configurations.
     */
    ...
    /**
     * Retrieves the URLs of virtual hosts.
     *
     * @return array The list of virtual host URLs with their enabled status.
     * @global object $bearsamppRoot Global object providing access to Bearsampp root configurations.
     */
    ...
    /**
     * Retrieves the list of directories in the www path.
     *
     * @return array The list of directories in the www path.
     * @global object $bearsamppRoot Global object providing access to Bearsampp root configurations.
     */
    ...
    /**
     * Executes a command line and retrieves its output.
     *
     * @param   string  $cmd  The command to execute.
     *
     * @return array The output of the command with syntax check status.
     */
    ...
    /**
     * Generates the content required to put the server online.
     *
     * @param   string|null  $version  The version of the server.
     *
     * @return string The content required to put the server online.
     */
    ...
    /**
     * Generates the content required to put the server offline.
     *
     * @param   string|null  $version  The version of the server.
     *
     * @return string The content required to put the server offline.
     */
    ...
    /**
     * Generates the required content based on the online status.
     *
     * @param   string|null  $version  The version of the server.
     *
     * @return string The required content based on the online status.
     */
    ...
    /**
     * Generates the content for an alias configuration.
     *
     * @param   string  $name  The name of the alias.
     * @param   string  $dest  The destination path for the alias.
     *
     * @return string The content for the alias configuration.
     */
    ...
    /**
     * Generates the content for a virtual host configuration.
     *
     * @param   string  $serverName    The server name for the virtual host.
     * @param   string  $documentRoot  The document root for the virtual host.
     *
     * @return string The content for the virtual host configuration.
     */
     ...
     *
     * @param   bool  $putOnline  Whether to put the server online.
     */
     ...
     *
     * @param   int      $enabled            The desired state of the module (Config::ENABLED or Config::DISABLED).
     * @param   bool     $showWindow         Whether to show a window with an error message if enabling fails.
     *
     * @global Config    $bearsamppConfig    The global configuration object.
     * @global Lang      $bearsamppLang      The global language object.
     * @global Winbinder $bearsamppWinbinder The global Winbinder object for displaying messages.
     */
    ...
    /**
     * Retrieves the access log file path.
     *
    ...
    /**
     * Retrieves the rewrite log file path.
     *
    ...
    /**
     * Retrieves the error log file path.
     *
    ...
    /**
     * Retrieves the SSL port number used by the module.
     *
    ...
    /**
     * Sets the SSL port number for the module.
     *
    ...
    /**
     * Retrieves the OpenSSL executable file path.
     *
