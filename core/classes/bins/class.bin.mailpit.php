...
class BinMailpit extends Module
{
    ...
    public function reload($id = null, $type = null)
    {
        ...
        if ($this->bearsamppConfRaw !== false) {
            ...
            $this->listen = $this->bearsamppConfRaw[self::LOCAL_CFG_LISTEN] ?? 'localhost'; // Default to localhost if not set
        }

        // Debug logs to verify values
        Util::logDebug("Mailpit configuration: Listen = {$this->listen}, UI Port = {$this->uiPort}, SMTP Port = {$this->smtpPort}");
