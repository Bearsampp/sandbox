 ...
 * Class AppPhpmyadmin
 *
 * This class represents the phpMyAdmin module within the Bearsampp application.
 * It extends the Module class and provides functionality specific to phpMyAdmin,
 * including configuration management and version handling.
 */
class AppPhpmyadmin extends Module
{
    ...
    /**
     * Reloads the module configuration and updates its properties.
     *
     ...
     *
     * @param string|null $version The version to update to (optional).
     * @param int $sub The sub-level of the update (optional).
     * @param bool $showWindow Whether to show a window during the update (optional).
