...
abstract class Module
{
    ...
    /**
     * Sets the version of the module and updates the global configuration.
     * Subclasses must define ROOT_CFG_VERSION; late static binding resolves
     * the correct constant at call time.
     *
    ...
    public function setVersion($version) {
        ...
        if (!defined(static::class . '::ROOT_CFG_VERSION')) {
            Log::error(static::class . ' does not define ROOT_CFG_VERSION; cannot persist version to config');
            return;
        }

        $this->version = $version;
        $bearsamppConfig->replace(static::ROOT_CFG_VERSION, $version);
        $this->reload();
    }
