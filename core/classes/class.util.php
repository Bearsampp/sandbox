...
class Util
{
     ...
     * including Apache, PHP, MySQL, MariaDB, PostgreSQL, Node.js, Composer, Cmder,
    ...
    private static function getPathsToScan()
    {
        ...
        // Cmder
        $folderList = self::getFolderList($bearsamppTools->getCmder()->getRootPath());
        foreach ($folderList as $folder) {
            $paths[] = array(
                'path'      => $bearsamppTools->getCmder()->getRootPath() . '/' . $folder,
