 ...
 *
 * This class is responsible for handling the action of setting the scan startup for repositories. * @since 2022.2.16
...
class ActionRefreshReposStartup
{
     ...
     *                    and the second argument is the value to set for the scan startup. * @since 2022.2.16
