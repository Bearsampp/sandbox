...
class ActionCheckVersion
{
    ...
    /**
     * ActionCheckVersion constructor.
     *
     * Initializes the class, checks the current version against the latest version available on GitHub,
     * and displays the appropriate window or message box based on the version comparison.
     *
    ...
    /**
     * Displays a window with the latest version information and a link to download the update.
     *
     * @param Lang $lang The language processor instance.
     * @param WinBinder $winbinder The WinBinder instance for creating and managing windows.
     * @param Core $core The core instance of the application.
    ...
    /**
     * Processes window events and handles user interactions with the window controls.
     *
     * @param int $window The window handle.
     * @param int $id The control ID that triggered the event.
     * @param int $ctrl The control handle.
