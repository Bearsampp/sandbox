 ...
 * Class ToolCmder
 *
 * This class represents the Cmder tool in the Bearsampp application.
 * It extends the Module class and provides functionalities specific to Cmder.
 */
class ToolCmder extends Module
{
    ...
    /**
     * Constructor for the ToolCmder class.
     *
    ...
    /**
     * Reloads the configuration for the Cmder tool.
     *
    ...
    /**
     * Sets the version of the Cmder tool.
     *
    ...
    /**
     * Gets the executable path for Cmder.
     *
    ...
    /**
     * Gets the launch executable path for Cmder.
     *
    ...
    /**
     * Gets the configuration file path for Cmder.
     *
    ...
    /**
     * Gets the number of rows for the Cmder window.
     *
    ...
    /**
     * Gets the number of columns for the Cmder window.
     *
    ...
    /**
     * Gets the shell command to launch Cmder.
     *
    ...
    /**
     * Gets the default tab title for Cmder.
     *
