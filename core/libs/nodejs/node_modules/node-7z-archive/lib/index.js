...
const onProgress = (firstChar) => function (data) {
    /**
...
function retry(command, options, override, progress, onprogress, resolve, reject, archive) {
    ...
    const runner = () => Run(executables[position], command, options, override)
        .progress((data) => progress(onprogress(data)))
        .then((args) => resolve(args)) // When all is done resolve the Promise.        
        .catch((err) => {
        if (position === executables.length - 1)
            return reject(err);
 ...
 */
export const createArchive = (SevenZip.createArchive =
    SevenZip.add =
 ...
 * @returns {Promise} Promise
 */
export const deleteArchive = (SevenZip.deleteArchive =
    SevenZip.delete =
        function (filepath, files, options, override = false) {
 ...
 * @returns {Promise} Promise
 */
export const extractArchive = (SevenZip.extractArchive =
    SevenZip.extract =
 ...
 * @returns {Promise} Promise
 */
export const fullArchive = (SevenZip.fullArchive =
    ...
    SevenZip.list =
        function (filepath, options, override = false) {
            return when.promise(function (resolve, reject, progress) {
                ...
                const runner = () => Run(executables[position], command, options, override)
                    .progress((data) => progress(onprogress(data)))
                    .then((args) => resolve(position === 0 ? spec : args))
                    .catch((err) => {
                    if (position === executables.length - 1)
                        return reject(err);
 ...
 * @returns {Promise} Promise
 */
export const onlyArchive = (SevenZip.onlyArchive =
    SevenZip.only =
 ...
 * @returns {Promise} Promise
 */
export const renameArchive = (SevenZip.renameArchive =
    SevenZip.rename =
        function (filepath, files, options, override = false) {
            return when.promise(function (resolve, reject, progress) {
 ...
 * @returns {Promise} Promise
 */
export const testArchive = (SevenZip.testArchive =
    SevenZip.test =
        function (filepath, options, override = false) {
            return when.promise(function (resolve, reject, progress) {
 ...
 * @returns {Promise} Promise
 */
export const updateArchive = (SevenZip.updateArchive =
    SevenZip.update =
        function (filepath, files, options, override = false) {
            return when.promise(function (resolve, reject, progress) {
                const onprogress = onProgress('U');
